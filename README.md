# SpottyData.com
This is a React site that attempts to push my original [Spotify Playlist Analyzer Python Project](https://github.com/NLeRoy917/spotify-playlist-analyzer). This project has since been made into a small API with Flask, and this code can be found [here](https://github.com/NLeRoy917/playlist-analyzer-api).
