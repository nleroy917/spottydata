...
import { SEO, Footer } from '../components/layout'
...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .get('https://api.github.com/repos/nleroy917/spottydata')
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      >
        <span>
          <span className="text-lg font-bold">
            Thank you for visiting Spottydata!
          </span>{' '}
          If you've been here before, things may look very different. The site
          is currently undergoing some major changes to provide an even better
          experience. Stay tuned for more and feel free to follow the progress
          or contribute by visitig the GitHub repository below!
        </span>
        <br></br>
        <button
          onClick={() => {
      ...
      <main className="w-11/12 md:max-w-screen-xl">
          ...
          <div className="flex flex-col items-center justify-start md:flex-row w-100">
            <div className="flex flex-row items-center my-1 md:my-0">
              <Link href="https://github.com/nleroy917/spottydata">
                <button className="px-2 py-1 text-xs font-bold text-white transition-all bg-black border-2 border-black rounded-l-lg md:text-sm hover:text-green-400">
                  ★ Star
                </button>
              </Link>
              <Link href="https://github.com/nleroy917/spottydata/stargazers">
                <button className="px-2 py-1 mr-2 text-xs font-bold transition-all border-2 border-l-0 border-black rounded-r-lg md:text-sm md:px-6 hover:text-green-400 hover:border-green-400">
                  {' '}
                  {starCount}
                </button>
              </Link>
            ...
            <button
              className="flex flex-row items-center px-2 py-1 transition-all bg-green-300 border-2 border-black rounded-lg hover:bg-green-500"
              onClick={() =>
                router.push(
                  'https://open.spotify.com/user/nleroy917?si=e902e8b373aa4a7d'
                )
              }
            >
              <Image
          ...
          <div className="flex flex-col items-center justify-center w-11/12 my-4 md:items-start">
            <p className="mb-2 text-sm text-center md:w-7/12 md:text-base md:text-left">
              ...
              <span className="font-bold text-green-500">
                Spotify profile analysis tool.
              </span>{' '}
              Spotty will analyze all of the music, artists, and albums across
              all playlists on your Spotify profile and give you rich insights
              into the genres you listen to, how frequently your favorite
              artists collaborate, as well as a look at the audio features of
              your music. Click below to get started!
            </p>
            <div>
              <Link href={authorize_url}>
                <button className="w-48 px-8 py-2 mt-4 mb-2 mr-2 text-xl font-bold transition-all bg-green-300 border-2 border-black rounded-lg hover:bg-green-500">
                  Lets Go
                </button>
              </Link>
            </div>
            <div className="my-2 md:flex md:flex-row md:items-center">
              <Link href="https://paypal.me/nathanleroy?locale.x=en_US">
                <button className="mr-4 font-bold transition-all hover:underline">
                  ☕ Support
                </button>
              </Link>
              <Link href="https://github.com/nleroy917/spottydata">
                <button className="ml-4 mr-2 font-bold transition-all hover:underline">
                  ⓘ Learn more
                </button>
              </Link>
            </div>
        ...
        <div
          className="fixed hidden mr-4 lg:block lg:top-48 lg:right-12 pb-14"
          style={{ zIndex: -1 }}
        >
          <img
            width="700"
