  ...
  return (
    <Head>
      ...
      <meta
        ...
        content={
          props.desc ||
          'A spotify profile analyzer. Analyze your profile, playlists, albums, and more!'
        }
      />
      ...
      <meta
        ...
        content="A spotify profile analyzer. Analyze your profile, playlists, albums, and more!"
      />
